...
//}
//
//func (queueSign *QueueSign) ZREMRANGEBYSCORE(rule Rule,scoreMax float32,scoreMin int)int{
//	key := queueSign.getRedisKey(rule)
//	res,err := redis.Int(redisDo("ZREMRANGEBYSCORE",redis.Args{}.Add(key).Add(scoreMin).Add(scoreMax)...))
//	if err !=nil{
//		zlib.ExitPrint("ZCOUNT err",err.Error())
//	}
//	return res
